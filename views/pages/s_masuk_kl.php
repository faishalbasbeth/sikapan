        ...
        <tr>
          ...
          <td class="text-center">
            <div class="btn-group" role="group">
                <a href="?controller=s_masuk&action=editStatus_KL&id_s_masuk=<?=$post->id_s_masuk?>" onclick="return confirm('Apakah Anda Yakin Untuk Mengubah Status?')" name ="status" class="btn btn-success"><span class="glyphicon glyphicon-ok"></span></a>
            </div>
          </td>
        </tr> <?php $i++;} ?>
        </table>
