    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <center><h1 class="page-header"><img src="home/images/file.png" alt="logout" height="50px">Data Surat Keluar Pertahun</h1></center>
    ...
    <div class="row">
      ...
      <table class="table table-striped table-bordered">
        <thead class="danger">
          ...
          <th style="text-align: center;">Total Surat Keluar</th>
          <?php $i=1; ?>
        ...
        <tr>
          ...
          <td style="text-align: center;"><?php echo $post->tahun_k; ?></td>
          <td style="text-align: center;"><?php echo $post->jumlah_tahunan_k; ?></td>
        </tr> <?php $i++;} ?> 
        </table>
