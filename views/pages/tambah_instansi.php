      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <form class="form-horizontal" method="GET">
            ...
            <input type="hidden" name="action" value="addDataInstansi">
            <div class="row">
              <div class="nyoba">
              <div class="col-lg-5">
                <div class="input-group">
                  <span class="input-group-addon" id="namaInstansi">Nama Instansi</span>
                  <input type="text" class="form-control" name="instansi" placeholder="BPBD JEMBER" aria-describedby="namaInstansi" required="">
                </div>
              </div>
              </div>
            </div>
          ...
          <div class="row">
              <div class="col-lg-10">
                <div class="input-group">
                  <span class="input-group-addon" id="alamatInstansi">Alamat Instansi</span>
                  <input type="text" class="form-control" name="alamat" placeholder="Jl. Danau Toba No.16, Lingkungan Panji, Tegalgede, Sumbersari, Kabupaten Jember, Jawa Timur 68124" aria-describedby="alamatInstansi" required="">
                </div>
              </div>
            </div>
          <br>
