      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li class="">
              <a href="?controller=beranda&action=berandaKL">Beranda
    ...
    <div class="row">
      <div class="col-md-13 col-md-offset-0">
        <form class="navbar-form navbar-right" method="GET">
                ...
                <input class="hidden" name="action" value="search_KL">
        ...
        <tr>
          ...
          <td class="text-center">
            <div class="btn-group" role="group">
                <a href="?controller=s_keluar&action=editStatus_KL&id_s_keluar=<?=$post->id_s_keluar?>" onclick="return confirm('Apakah Anda Yakin Untuk Mengubah Status?')" name ="status" class="btn btn-success"><span class="glyphicon glyphicon-ok"></span></a>
            </div>
          </td>
        </tr> <?php $i++;} ?>
        </table>
