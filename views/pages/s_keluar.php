  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-13 col-md-offset-0">
        <a href="?controller=s_keluar&action=tampilAddS_keluar">
      ...
      <table class="table table-striped table-bordered">
        ...
        <tr>
          ...
          <td class="text-center">
            <a href="?controller=s_keluar&action=deleteS_keluar&id_s_keluar=<?php echo $post->id_s_keluar ?>" onclick="return confirm('Apakah Anda Yakin Untuk Menghapus?')"><button class="btn btn-danger bold">Hapus</button></a>
          </td>
        </tr> <?php $i++;} ?>
        </table>
    <br>
