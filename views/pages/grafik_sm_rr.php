      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <br>
          <li class=""><a href="?controller=s_keluar&action=s_keluarRR">Surat Keluar
            ...
            <ul class="nav navbar-nav">
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a href="?controller=beranda&action=berandaRR">Grafik Total</a></li>
                  <li class="divider"></li>
                  <li><a href="?controller=s_masuk&action=grafik_sm_rr">Grafik Surat Masuk</a></li>
                  
                  <li class="divider"></li>
                  <li><a href="?controller=s_keluar&action=grafik_sk_rr">Grafik Surat Keluar</a></li>
                </ul>
              </li>
            </ul>
          </div>
