      ...
      <div class="container-fluid">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            <li>
              <font class="navbar-brand" size="5" color="blue"><a href="">REHABILITASI & REKONSTRUKSI</a></font>
            </li>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li class="">
              <a href="?controller=beranda&action=berandaRR">Beranda
        ...
        <tr>
          ...
          <td class="text-center">
            <div class="btn-group" role="group">
                <a href="?controller=s_masuk&action=editStatus_RR&id_s_masuk=<?=$post->id_s_masuk?>" onclick="return confirm('Apakah Anda Yakin Untuk Mengubah Status')" name ="status" class="btn btn-success"><span class="glyphicon glyphicon-ok"></span></a>
            </div>
          </td>
        </tr> <?php $i++;} ?>
        </table>
